...
public class ColumnChartView extends View {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.MyChartView_xyColor:
                    lineColor = array.getColor(attr, Color.WHITE);
                    break;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            canvas.drawText(String.valueOf(i + 1), mStartWidth - mBound.width() * 1 / 2,
        ...
        for (int i = 0; i < 12; i++) {
            ...
            if (list.size() > 0) {
                if (selectIndexRoles.contains(i)){
                   ...
                   mChartPaint.setColor(0x20FFFF00);
                }
                //画柱状图
