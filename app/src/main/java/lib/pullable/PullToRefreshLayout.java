...
import lib.util.TmToast;

import static com.lsy.hebao.app.HebaoApplication.context;
...
public class PullToRefreshLayout extends RelativeLayout {
	...
	private void initView(Context context) {
		...
		rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.reverse_anim_pullable_liao);
		refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.rotating_pullable_liao);
		// 添加匀速转动动画
	...
	public void refreshFinish(int refreshResult) {
		...
		switch (refreshResult) {
			...
			//	TmToast.show(context, "", true, Toast.LENGTH_SHORT).show();
